...
namespace aalapChat
{
    ...
    public class dbSet
    {
        ...
        private DataTable dt, contactsTable, frndInfoTable,msgTable,myPassword;
        ...
        public String getMyPass(string query)
        { 
            try
            {
                con.Open();
            ...
            return myPassword.Rows[0]["password"].ToString();
        }
